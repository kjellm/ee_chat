...
var _user$project$EEChat$onEnter = function (msg) {
...
var _user$project$EEChat$model = {
	nick: '',
	nickAccepted: false,
	newMessage: '',
	chatBuffer: '',
	phxSocket: _fbonetti$elm_phoenix_socket$Phoenix_Socket$init('http://localhost:4000/socket/websocket')
};
var _user$project$EEChat$init = {ctor: '_Tuple2', _0: _user$project$EEChat$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$EEChat$Model = F5(
	function (a, b, c, d, e) {
		return {nick: a, nickAccepted: b, newMessage: c, chatBuffer: d, phxSocket: e};
	});
var _user$project$EEChat$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$EEChat$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$EEChat$PhoenixMsg);
};
var _user$project$EEChat$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdateNick':
							...
							chatBuffer: A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'* ',
										A2(_elm_lang$core$Basics_ops['++'], model.nick, ' joined the chat *'))))
						}),
					{ctor: '[]'});
			case 'AcceptNewMessage':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
							...
							chatBuffer: A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										model.nick,
										A2(_elm_lang$core$Basics_ops['++'], '> ', model.newMessage)))),
							newMessage: ''
						}),
					{ctor: '[]'});
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{phxSocket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$EEChat$PhoenixMsg, phxCmd)
				};
		}
	});
var _user$project$EEChat$UpdateNewMessage = function (a) {
	return {ctor: 'UpdateNewMessage', _0: a};
};
var _user$project$EEChat$UpdateNick = function (a) {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('nick'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$EEChat$UpdateNick),
						_1: {
							ctor: '::',
							_0: _user$project$EEChat$onEnter(_user$project$EEChat$AcceptNick),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$EEChat$AcceptNick),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$EEChat$main = _elm_lang$html$Html$program(
	{init: _user$project$EEChat$init, view: _user$project$EEChat$view, update: _user$project$EEChat$update, subscriptions: _user$project$EEChat$subscriptions})();

var Elm = {};
Elm['EEChat'] = Elm['EEChat'] || {};
if (typeof _user$project$EEChat$main !== 'undefined') {
    _user$project$EEChat$main(Elm['EEChat'], 'EEChat', undefined);
}
